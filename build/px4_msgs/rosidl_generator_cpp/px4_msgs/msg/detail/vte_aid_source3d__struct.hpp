...
// IWYU pragma: private, include "px4_msgs/msg/vte_aid_source3d.hpp"


#ifndef PX4_MSGS__MSG__DETAIL__VTE_AID_SOURCE3D__STRUCT_HPP_
#define PX4_MSGS__MSG__DETAIL__VTE_AID_SOURCE3D__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4_msgs__msg__VteAidSource3d __attribute__((deprecated))
#else
# define DEPRECATED__px4_msgs__msg__VteAidSource3d __declspec(deprecated)
#endif
...
struct VteAidSource3d_
{
  using Type = VteAidSource3d_<ContainerAllocator>;

  explicit VteAidSource3d_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      std::fill<typename std::array<uint8_t, 3>::iterator, uint8_t>(this->fusion_status.begin(), this->fusion_status.end(), 0);
      this->time_since_meas_ms = 0.0f;
      this->history_steps = 0;
    }
  }

  explicit VteAidSource3d_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : observation(_alloc),
  ...
  // pointer types
  using RawPtr =
    px4_msgs::msg::VteAidSource3d_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4_msgs::msg::VteAidSource3d_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4_msgs::msg::VteAidSource3d_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4_msgs::msg::VteAidSource3d_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4_msgs::msg::VteAidSource3d_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::VteAidSource3d_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::VteAidSource3d_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4_msgs::msg::VteAidSource3d_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4_msgs::msg::VteAidSource3d_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4_msgs__msg__VteAidSource3d
    std::shared_ptr<px4_msgs::msg::VteAidSource3d_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4_msgs__msg__VteAidSource3d
    std::shared_ptr<px4_msgs::msg::VteAidSource3d_<ContainerAllocator> const>
  ...
  bool operator==(const VteAidSource3d_ & other) const
  {
...
using VteAidSource3d =
  px4_msgs::msg::VteAidSource3d_<std::allocator<void>>;

// constant definitions
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VteAidSource3d_<ContainerAllocator>::STATUS_IDLE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VteAidSource3d_<ContainerAllocator>::STATUS_FUSED_CURRENT;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VteAidSource3d_<ContainerAllocator>::STATUS_FUSED_OOSM;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VteAidSource3d_<ContainerAllocator>::STATUS_REJECT_NIS;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VteAidSource3d_<ContainerAllocator>::STATUS_REJECT_COV;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VteAidSource3d_<ContainerAllocator>::STATUS_REJECT_TOO_OLD;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VteAidSource3d_<ContainerAllocator>::STATUS_REJECT_TOO_NEW;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VteAidSource3d_<ContainerAllocator>::STATUS_REJECT_STALE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t VteAidSource3d_<ContainerAllocator>::STATUS_REJECT_EMPTY;
#endif  // __cplusplus < 201703L
...
#endif  // PX4_MSGS__MSG__DETAIL__VTE_AID_SOURCE3D__STRUCT_HPP_
